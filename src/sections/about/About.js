        ...
        <div className="section section-about section-about-1 overlay-pattern">
            ...
            <div className="display-spacing">
                <Container>
                    <Row>
                        <Col xl={6}>
                            <Heading label="About Me" title="Our Professional Team gives you Best Service and Excellent Support." subtitle="We provide the best service that comes with the best results. We help to develop your business. We provide the best service that comes with the best results. Our strategies at work are the means by which to achieve the desired goals." />
                        ...
                        <Col xl={6}>
                            <div className="about-us-box overlay-pattern">
